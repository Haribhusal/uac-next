      ...
      <nav className="bg-white border-gray-200 px-2 sm:px-3 md:px-10 py-2.5">
        <div className="flex flex-wrap items-center justify-between">
          ...
          <div className="flex md:order-2 items-center">
            <button
              type="button"
              className=" bg-blue-100 text-blue-700 hover:bg-blue-800 hover:text-white transition-all  font-medium rounded-lg text-sm md:px-5 sm:px-3 py-2.5 text-center mr-3 md:mr-3 "
            >
              Login
            </button>
            <button
              type="button"
              className="text-white bg-blue-700 hover:bg-blue-800  font-medium rounded-lg text-sm md:px-10 sm:px-3 py-2.5 text-center mr-3 md:mr-0 "
            >
              Get started
            </button>
            <button
              ...
              type="button"
              className="inline-flex items-center p-2 text-sm rounded-lg md:hidden hover:bg-gray-100 bg-blue-100 text-blue-700 focus:rounded"
